"""
Memory-scoped LTX 2.3 distilled modular SDNQ text-to-image runner.
...
modules keep their native forward path; this runner uses official Diffusers
group offloading instead of DDO dynamic offload.
"""
...
MODEL_TAG = "distilled_modular_sdnq_diffusers_group_offload"
SDNQ_MODEL_PATHS = {
...
def parse_args():
    parser = argparse.ArgumentParser(description="LTX 2.3 distilled modular SDNQ text-to-image runner.")
