...
_DYNAMIC_WEIGHTS_PRESET_VALUES: dict[str, dict[str, str]] = {
    ...
    "diffusers_leaf_offload_compat": {
        ...
        "DIFFUSERS_RUNNER_TRANSFORMER_GROUP_OFFLOAD": "1",
        "DIFFUSERS_RUNNER_TRANSFORMER_OFFLOAD_TYPE": "leaf_level",
        "DIFFUSERS_RUNNER_TRANSFORMER_OFFLOAD_STREAM": "1",
        "DIFFUSERS_RUNNER_TRANSFORMER_OFFLOAD_RECORD_STREAM": "1",
        "DIFFUSERS_RUNNER_TRANSFORMER_OFFLOAD_LOW_CPU_MEM_USAGE": "1",
    ...
    "diffusers_offload_compat": {
        ...
        "DIFFUSERS_RUNNER_TRANSFORMER_MEMORY_MANAGER": "off",
        "DIFFUSERS_RUNNER_TRANSFORMER_GROUP_OFFLOAD": "1",
        "DIFFUSERS_RUNNER_TRANSFORMER_OFFLOAD_TYPE": "block_level",
        "DIFFUSERS_RUNNER_TRANSFORMER_OFFLOAD_STREAM": "1",
        "DIFFUSERS_RUNNER_TRANSFORMER_OFFLOAD_RECORD_STREAM": "1",
        "DIFFUSERS_RUNNER_TRANSFORMER_OFFLOAD_LOW_CPU_MEM_USAGE": "1",
        "DIFFUSERS_RUNNER_TRANSFORMER_NUM_BLOCKS_PER_GROUP": "1",
        "DIFFUSERS_RUNNER_ATTENTION_BACKEND": "native",
        "DIFFUSERS_DYNAMIC_WEIGHTS_EXECUTION_MODE": "plan",
        "DIFFUSERS_DYNAMIC_WEIGHTS_PLAN": "0",
        "DIFFUSERS_RUNNER_PRE_VAE_CLEANUP_REPEATS": "1",
