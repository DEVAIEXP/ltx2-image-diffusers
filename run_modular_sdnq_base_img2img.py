"""
Memory-scoped LTX 2 image modular SDNQ image-to-image runner.
...
between phases. Quantized modules keep their native forward path and use
official Diffusers group offloading.
"""
...
MODEL_TAG = "base_modular_sdnq_img2img_diffusers_group_offload"
SDNQ_MODEL_PATHS = {
...
def parse_args():
    parser = argparse.ArgumentParser(description="LTX 2 image modular SDNQ img2img runner.")
