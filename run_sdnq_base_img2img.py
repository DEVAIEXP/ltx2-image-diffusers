"""
Standalone LTX 2.3 base image-to-image script.
...
def parse_args():
    parser = argparse.ArgumentParser(description="LTX 2.3 base SDNQ img2img test.")
...
def main():
    ...
    transformer_src = sdnq_model_path
