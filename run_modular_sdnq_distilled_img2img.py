"""
Memory-scoped LTX 2.3 distilled modular SDNQ image-to-image runner.
...
it. Quantized modules keep their native forward path and use official Diffusers
group offloading.
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="LTX 2.3 distilled modular SDNQ img2img runner.")
