"""
Memory-scoped LTX 2 image modular text-to-image runner.

This runner uses the custom modular blocks step by step, so the text encoder,
connectors, transformer, and VAE do not stay resident together.
"""
...
def main():
    ...
    print("Using modular base Diffusers group offload", flush=True)
